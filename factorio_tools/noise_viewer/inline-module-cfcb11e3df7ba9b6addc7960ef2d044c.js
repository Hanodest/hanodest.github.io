...
function ue(e,t){return(t,i,s)=>((e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,i),i))(t,i,{get(){return(t=>t.renderRoot?.querySelector(e)??null)(this)}})}var he=function(e,t,i,s){var n,o=arguments.length,a=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(o<3?n(a):o>3?n(t,i,a):n(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let Ae=class extends oe{constructor(){super(),this.collapsed=!1,this.collapsed=!1}onClick(){this.collapsed=!this.collapsed,this.dispatchEvent(new CustomEvent("collapse-toggle",{bubbles:!0,composed:!0,detail:this.collapsed}))}render(){return D`<div
  ...
  `,he([ce({type:Boolean})],Ae.prototype,"collapsed",void 0),Ae=he([re("nv-collapse-icon")],Ae);let fe=class extends oe{constructor(){super(),this.caption="",this.collapsed=!1,this.concealed=!1,this.concealable=!1,this.deleteable=!1,this.moveable=!1,this.nudgeable=!1,this.addEventListener("collapse-toggle",e=>{e.stopPropagation(),this.collapsed=e.detail})}render(){return D`
      <div>
        <div
          class="header"
  ...
  `,he([ce({type:String})],fe.prototype,"caption",void 0),he([ce({type:Boolean})],fe.prototype,"collapsed",void 0),he([ce({type:Boolean})],fe.prototype,"concealed",void 0),he([ce({type:Boolean})],fe.prototype,"concealable",void 0),he([ce({type:Boolean})],fe.prototype,"deleteable",void 0),he([ce({type:Boolean})],fe.prototype,"moveable",void 0),he([ce({type:Boolean})],fe.prototype,"nudgeable",void 0),fe=he([re("nv-collapse")],fe);var me,ge,ve=function(e,t,i,s,n){if("m"===s)throw new TypeError("Private method is not writable");if("a"===s&&!n)throw new TypeError("Private accessor was defined without a setter");if("function"==typeof t?e!==t||!n:!t.has(e))throw new TypeError("Cannot write private member to an object whose class did not declare it");return"a"===s?n.call(e,i):n?n.value=i:t.set(e,i),i},ye=function(e,t,i,s){if("a"===i&&!s)throw new TypeError("Private accessor was defined without a getter");if("function"==typeof t?e!==t||!s:!t.has(e))throw new TypeError("Cannot read private member from an object whose class did not declare it");return"m"===i?s:"a"===i?s.call(e):s?s.value:t.get(e)};class xe{constructor(e,t){me.set(this,void 0),ge.set(this,void 0),ve(this,me,e,"f"),ve(this,ge,t,"f")}get x(){return ye(this,me,"f")}set x(e){ve(this,me,e,"f")}get y(){return ye(this,ge,"f")}set y(e){ve(this,ge,e,"f")}add(e){return new xe(this.x+e.x,this.y+e.y)}subtract(e){return new xe(this.x-e.x,this.y-e.y)}vmul(e){return this.x*e.y-e.x*this.y}smul(e){return this.x*e.x+this.y*e.y}mul(e){return new xe(this.x*e,this.y*e)}get len(){return Math.sqrt(this.smul(this))}min(e){return new xe(Math.min(this.x,e.x),Math.min(this.y,e.y))}max(e){return new xe(Math.max(this.x,e.x),Math.max(this.y,e.y))}floor(){return new xe(Math.floor(this.x),Math.floor(this.y))}ceil(){return new xe(Math.ceil(this.x),Math.ceil(this.y))}asArray(){return[this.x,this.y]}}me=new WeakMap,ge=new WeakMap;var _e,be,Ee,we,$e,Ce=function(e,t,i,s){var n,o=arguments.length,a=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(o<3?n(a):o>3?n(t,i,a):n(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a},Re=function(e,t,i,s){if("a"===i&&!s)throw new TypeError("Private accessor was defined without a getter");if("function"==typeof t?e!==t||!s:!t.has(e))throw new TypeError("Cannot read private member from an object whose class did not declare it");return"m"===i?s:"a"===i?s.call(e):s?s.value:t.get(e)},Se=function(e,t,i,s,n){if("m"===s)throw new TypeError("Private method is not writable");if("a"===s&&!n)throw new TypeError("Private accessor was defined without a setter");if("function"==typeof t?e!==t||!n:!t.has(e))throw new TypeError("Cannot write private member to an object whose class did not declare it");return"a"===s?n.call(e,i):n?n.value=i:t.set(e,i),i};let Te=class extends oe{constructor(){super(),_e.add(this),this.active=!1,be.set(this,void 0),Se(this,be,e=>{Re(this,_e,"m",we).call(this,e)},"f")}render(){return D`
    ...
    >
      ${zt(e.compilationError,()=>D`<div class="error-message">${e.compilationError}</div>`,()=>{const t=e.sourceMap;return D`<div
            ...
            <div class="expression-container">
              ...
              ${zt(t.localExpressions.size>0,()=>D`
                  <table class="local-expressions">
                    ${Array.from(t.localExpressions).sort((e,t)=>e[0].localeCompare(t[0])).map(([t,i])=>{const s={localExpressionName:t,...e.id};return D`<tr
                          class="${s.type===this.selectedExpression?.type&&s.name===this.selectedExpression?.name&&s.localExpressionName===this.selectedExpression?.localExpressionName?"selected":""}"
                        >
                          <td
                            class="local-expression-name"
                            id=${Tt(s)}
                            @click=${()=>{this.renderController.select(s)}}
                            @mouseenter=${()=>{this.renderController.preview(s)}}
                            @mouseleave=${()=>{this.renderController.cancelPreview()}}
                          >
                            ${t}
                          </td>
...
const Ht="important",Xt=" !"+Ht,Gt=Oe(class extends je{constructor(e){if(super(e),e.type!==Ue||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(t)),this.render(t);for(const e of this.ft)null==t[e]&&(this.ft.delete(e),e.includes("-")?i.removeProperty(e):i[e]=null);for(const e in t){const s=t[e];if(null!=s){this.ft.add(e);const t="string"==typeof s&&s.endsWith(Xt);e.includes("-")||t?i.setProperty(e,t?s.slice(0,-11):s,t?Ht:""):i[e]=s}}return z}});var Jt=function(e,t,i,s){var n,o=arguments.length,a=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(o<3?n(a):o>3?n(t,i,a):n(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let Lt=class extends oe{constructor(){super(),this.data=void 0,this.positionX=0,this.positionY=0}render(){if(!this.data)return Q;const e=Math.max(...this.data.map(e=>e.value)),t=this.data.findLastIndex(t=>t.value===e);return D`
  ...
  `,oi=ni([re("nv-tooltip")],oi);var ai=function(e,t,i,s){var n,o=arguments.length,a=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,s);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(o<3?n(a):o>3?n(t,i,a):n(t,i))||a);return o>3&&a&&Object.defineProperty(t,i,a),a};let ri=class extends oe{constructor(){super(),this.concealed=!0,this.expression="",this.localExpressions=[],this.errorMessage=""}render(){return D`
          ...
          ${zt(this.localExpressions.length>0,()=>D`<div>
              <table>
                ${Array.from(this.localExpressions).map((e,t)=>D`<tr>
                    <td><input type="text" value=${e.name} @change=${t=>{t.stopPropagation(),e.name=t.target.value.trim()}}></input></td>
                    <td><textarea @change=${t=>{t.stopPropagation(),e.expression=t.target.value.trim()}}
                    .value=${e.expression}></textarea></td>
    ...
    `}open(){const e=this.displayExpression.sourceMap;this.expression=e.expression.text,this.localExpressions=Array.from(e.localExpressions).map(([e,t])=>({name:e,expression:t.text})),this.errorMessage="",this.concealed=!1}discardChanges(){this.concealed=!0}validateExpression(){try{if(""==this.expression)throw"Expression must be non-empty";const e=new Map(this.localExpressions.filter(e=>""!=e.name&&""!=e.expression).map(e=>[e.name,e.expression]));this.executor.replaceExpression(this.displayExpression.id,this.expression,e),this.concealed=!0,this.dispatchEvent(new CustomEvent("update"))}catch(e){this.errorMessage=`${e}`}}};ri.styles=[Le,o`
      .edit-icon {
